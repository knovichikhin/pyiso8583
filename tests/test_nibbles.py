...
# fmt: off
@pytest.mark.parametrize(
    ["data_enc", "len_enc", "len_count", "data", "result_f2_len"],
    [
        ("ascii", "ascii", "bytes", b"02004000000000000000041234", b"04"),
        ("ascii", "ascii", "nibbles", b"02004000000000000000081234", b"08"),
        ("ascii", "b", "bytes", b"02004000000000000000\x00\x041234", b"\x00\x04"),
        ("ascii", "b", "nibbles", b"02004000000000000000\x00\x081234", b"\x00\x08"),
        ("b", "ascii", "bytes", b"0200400000000000000002\x12\x34", b"02"),
        ("b", "ascii", "nibbles", b"0200400000000000000004\x12\x34", b"04"),
        ("b", "b", "bytes", b"02004000000000000000\x00\x02\x12\x34", b"\x00\x02"),
        ("b", "b", "nibbles", b"02004000000000000000\x00\x04\x12\x34", b"\x00\x04"),
     ],
)
# fmt: on
def test_decode_nibbles(
    data_enc: str, len_enc: str, len_count: str, data: bytes, result_f2_len: bytes
) -> None:
    spec["t"]["data_enc"] = "ascii"
    spec["p"]["data_enc"] = "ascii"
